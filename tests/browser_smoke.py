...
with sync_playwright() as p:
    ...
    for width,height in [(1440,1000),(390,844)]:
        ...
        page.locator('#exploreCurrency').select_option('KRW')
        ...
        page.locator('#detailCurrency').select_option('USD')
        ...
        page.locator('#detailCurrency').select_option('KRW')
    ...
    page.locator('[data-asset="us"]').click()
    page.locator('[data-kind="up"]').click()
    expect(page.locator('#exploreRows .admin-meta-mobile summary')).to_be_visible()
    page.locator('#exploreRows .admin-meta-mobile summary').click()
    expect(page.locator('#exploreRows .admin-meta-mobile')).to_contain_text('브라우저 테스트 시세 진단')
    assert page.evaluate('document.documentElement.scrollWidth <= window.innerWidth+1')
    page.screenshot(path='/artifacts/explore-admin-390.png',full_page=True)
    page.locator('.app-nav a[href="#ranking"]').click()
    expect(page.locator('#ranking')).not_to_contain_text('browser_admin')
    page.close()
    browser.close()
