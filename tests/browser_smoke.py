...
with sync_playwright() as p:
    ...
    for width,height in [(1440,1000),(390,844)]:
        ...
        page.locator('#orderPreview').click()
        ...
        expect(page.locator('#watchRows')).to_contain_text('AAPL')
        page.locator('a[href="#portfolio"]').click()
