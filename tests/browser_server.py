...
class FixtureMarket:
    ...
    def movers(self,direction):return {'rows':[instrument('AAPL')|{'market':'US','price':100,'change_pct':1,'volume':10000,'data_time':'test'}],'scope':'테스트 전용','notice':'운영 공급자 아님'}
